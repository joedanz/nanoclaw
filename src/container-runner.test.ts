...
import { AGENT_RUNNER_BASE_VERSION } from './evolution-host.js';
...
// Note: agent-runner sync tests and personality versioning tests
// have been moved to evolution-host.test.ts where the functions now live.
