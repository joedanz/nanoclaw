...
export class TelegramChannel implements Channel {
  ...
  async connect(): Promise<void> {
    ...
    // On restart (launchctl kickstart -k), old and new process briefly
    // overlap their getUpdates calls, causing Telegram to return 409.
    // grammY throws this from Bot.loop as an unhandled promise rejection.
    // We catch it on bot.start() and retry with a new Bot instance.
